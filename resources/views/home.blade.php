...
@section('content')
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>DompetKu.</h1>
      <p>untuk <span class="typed" data-typed-items="Memanage, Mengatur, Memperkaya, isi Dompet."></span></p>
      <br>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Dompetku adalah aplikasi untuk memanage, mengatur, dan memperkaya keuangan kalian. dengan menggunakan Dompetku kalian juga bisa melihat portofolio keuangan kalian. Dompetku juga bisa membuat laporan keuangan kalian dengan interval harian, bulanan, maupun tahunan. dengan menggunakan DompetKu diharapkan kalian bisa mengatur keuangan kalian dengan lebih baik dan dapat memperkaya kalian</p>
        </div>
